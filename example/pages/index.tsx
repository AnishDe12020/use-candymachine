...
import { Grid, Card, Text, Pagination, Loading, Container, Button } from "@nextui-org/react";
...
const Home: NextPage = () => {
	...
	const {
		...
		initialFetch,
		mint
	} = useCandymachine(connection, "AVSqKTyhvWB2gViNpaytGe3riRDjHGLEQ5q15JYKuHfT", 4, walletAdapter);
